...
class NoteHubApp {
    ...
    renderEditor() {
        ...
        const updateLineNumbers = () => {
            ...
            // Count actual visible lines in the textarea
            ...
            // Get cursor position to calculate relative numbers
            let cursorLine = 0;
            if (relativeNums) {
            ...
            ln.innerHTML = Array.from({ length: lineCount }, (_, i) => {
                ...
                if (relativeNums) {
                    if (i === cursorLine) {
                        num = i + 1; // Show absolute number on current line
                    } else {
                        num = Math.abs(i - cursorLine); // Show distance from cursor
                    }
                } else {
                    num = i + 1; // Standard absolute line numbers
                }
